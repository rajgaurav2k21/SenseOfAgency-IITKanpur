    ...
    public class iOSDLLDownloader
    {
        ...
        private static void DownloadAndExtract(string outputPath)
        {
            try
            {
                ...
                else
                {
                    ...
                    string zipPath = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "downloaded.zip");
        ...
        private static void ExtractZipFile(string zipFilePath, string outputFolder)
        {
            ...
            using (ZipArchive archive = ZipFile.OpenRead(zipFilePath))
            {
                ...
                {
                    string fullPath = System.IO.Path.Combine(outputFolder, entry.FullName);
        ...
        {
            _targetDirectory = System.IO.Path.Combine(Application.dataPath, RELATIVE_PATH);
        ...
        {
            string fullPath = System.IO.Path.Combine(Application.dataPath, RELATIVE_PATH + "/ios/libgrpc.a");
