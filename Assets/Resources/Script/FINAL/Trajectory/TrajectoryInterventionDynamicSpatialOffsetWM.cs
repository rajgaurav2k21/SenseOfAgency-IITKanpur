...
public class TrajectoryInterventionDynamicSpatialOffsetWM : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        filePath = Application.dataPath + "/CSV/Trajectory/InterventionDynamicSpatialOffsetWeightMarker.csv";
